...
namespace eFact_RN
{
    public class Lote
    {
        ...
        public static void DeserializarLc(out FeaEntidades.InterFacturas.lote_comprobantes Lc, eFact_Entidades.Lote Lote, bool IF)
        {
        ...
        private static string Cadena(eFact_Entidades.Lote Lote, bool IF)  
        {
            string cadena = "";
            if (IF)
            {
        ...
        private static void GenerarNombreArch(out string NombreArch, string Ruta, string Prefijo, eFact_Entidades.Lote Lote, string Extension)
        {
        ...
        public static void MuestroEsquemaSegEventosPosibles(System.Windows.Forms.TreeView tvw, eFact_Entidades.Lote lote) 
        {
        ...
        public static void Lc2Lote(out eFact_Entidades.Lote Lote, FeaEntidades.InterFacturas.lote_comprobantes Lc, eFact_Entidades.Aplicacion Aplicacion, CedEntidades.Sesion Sesion)
        {
            ...
            //eFact_RN.Lote.ObtenerNumeroEnvioDisponible(out numeroEnvioDisponible, lote.CuitVendedor, lote.NumeroLote, lote.PuntoVenta, eFact_Aplicacion.Sesion);
