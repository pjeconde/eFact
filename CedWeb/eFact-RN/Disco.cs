...
namespace eFact_RN
{
    public class Disco
    {
        public static List<eFact_Entidades.Disco> Lista()
        {
            List<eFact_Entidades.Disco> discos = new List<eFact_Entidades.Disco>();
            ManagementObjectSearcher searcher = new ManagementObjectSearcher("SELECT * FROM Win32_DiskDrive");
            foreach (ManagementObject wmi_HD in searcher.Get())
            {
                eFact_Entidades.Disco disco = new eFact_Entidades.Disco();
            ...
            foreach (ManagementObject wmi_HD in searcher.Get())
            {
                ...
                eFact_Entidades.Disco disco = (eFact_Entidades.Disco)discos[i];
        ...
        public static string ClaveSolicitud()
        {
            ...
            List<eFact_Entidades.Disco> discos = Lista();
