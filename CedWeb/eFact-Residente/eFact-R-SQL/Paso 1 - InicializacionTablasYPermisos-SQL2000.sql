...
use [master]
exec sp_addlogin @loginame='usr_eFact', @passwd='123456', @defdb='eFact-R'

use [eFact-R]
exec sp_adduser @loginame='usr_eFact', @name_in_db='usr_eFact'

use [eFact-R]
exec sp_addrole 'ce_update'
use [eFact-R]
...
alter table Comprobantes add ComentarioIFoAFIP varchar(7800) null
GO