<%@ Page AutoEventWireup="true" Codebehind="Explorador.aspx.cs" Inherits="CedeiraAJAX.Admin.Vendedor.Explorador"
...
<asp:content id="AdminVendedorContent" runat="Server" contentplaceholderid="AdministracionContentPlaceHolder">
                            ...
                            <table border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td style="height: 20px;">
                                        <asp:Label ID="TituloLabel" runat="server" SkinID="TituloPagina" Text="Vendedores"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                        </td>
