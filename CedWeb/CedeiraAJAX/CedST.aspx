<%@ Page Language="C#" MasterPageFile="~/CedeiraAJAX.Master" AutoEventWireup="true" CodeBehind="CedST.aspx.cs" Inherits="CedeiraAJAX.CedST"  %>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td style="height: 20px">
                                        <asp:Label ID="CedSTtituloLabel" runat="server" SkinID="TituloPagina" Text="Sistema de Transferencias ( implementación MEP )"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
