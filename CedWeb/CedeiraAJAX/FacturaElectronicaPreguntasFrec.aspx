<%@ Page Language="C#" MasterPageFile="~/CedeiraAJAX.Master" AutoEventWireup="true" CodeBehind="FacturaElectronicaPreguntasFrec.aspx.cs" Inherits="CedeiraAJAX.FacturaElectronicaPreguntasFrec"  %>
                ...
                <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td style="height: 20px;">
                            <asp:Label ID="LabelTitFacturaElectronica" runat="server" SkinID="TituloPagina" Text="Preguntas frecuentes"></asp:Label>
                        </td>
                    </tr>
                </table>
                <table border="0" cellpadding="0" cellspacing="0">
                            ...
                            <table border="0" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="http://www.interfacturas.com.ar"
                                            SkinID="LinkMedianoClaro" Target="_blank">aqui</asp:HyperLink>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding-top: 10px">
                                ...
                                <tr>
                                    <td style="padding-top: 10px">
                                        ...
                                        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="http://www.afip.gov.ar/efactura"
                                            SkinID="LinkMedianoClaro" Target="_blank">AFIP-Factura Electrónica / Comprobantes en Línea</asp:HyperLink>
                                    </td>
                                </tr>
                            </table>
                        </td>
