<%@ Page Language="C#" MasterPageFile="~/CedeiraAJAX.Master" AutoEventWireup="true" CodeBehind="CuentaCrear.aspx.cs" Inherits="CedeiraAJAX.CuentaCrear"  %>
                        ...
                        <td align="left" colspan="2" style="padding-left: 32px">
                            ...
                            <table id="Table1" border="0" cellpadding="0" cellspacing="0" width="600">
                                ...
                                <tr>
                                    ...
                                    <td align="left" colspan="2" style="padding-top: 3px">
                                        <asp:DropDownList ID="MedioDropDownList" runat="server" TabIndex="9" Width="183px">
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                                <tr>
