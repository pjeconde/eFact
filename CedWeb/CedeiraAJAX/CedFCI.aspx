<%@ Page Language="C#" MasterPageFile="~/CedeiraAJAX.Master" AutoEventWireup="true" CodeBehind="CedFCI.aspx.cs" Inherits="CedeiraAJAX.CedFCI"  %>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td style="height: 20px">
                                        <asp:Label ID="CedSTtituloLabel" runat="server" SkinID="TituloPagina" Text="Sistema de Administración de Fondos Comunes de Inversión"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td style="padding-left: 5px">
                                                    <b>Calcula los valores de cuotaparte</b> de las clases emitidas para todos los fondos,
                                                    en forma automática.
                                                </td>
                                            </tr>
                                            <tr>
                                                <td valign="top">
                                                    •</td>
                                                <td style="padding-left: 5px">
                                                    <b>Facilita el ingreso de novedades</b> (operaciones, cierres de cambio, precios,
                                                    tasas de cuentas remuneradas, suscripciones y rescates, etc).
                                                </td>
                                            </tr>
                                            <tr>
                                                <td valign="top">
                                                    •</td>
                                                <td style="padding-left: 5px">
                                                    <b>Facilita la configuración de datos básicos</b> (fondos, clases, fees de administración,
                                                    plan de cuentas, especies, entidades, monedas, etc).
                                                </td>
                                            </tr>
                                            <tr>
                                                <td valign="top">
                                                    •</td>
                                                <td style="padding-left: 5px">
                                                    Provee un repositorio único, para facilitar la <b>administración centralizada</b>,
                                                    pero, manteniendo la <b>independencia de cada fondo</b>.
                                                </td>
                                            </tr>
                                            <tr>
                                                <td valign="top">
                                                    •</td>
                                                <td style="padding-left: 5px">
                                                    Confiere una mayor <b>uniformidad</b> en el tratamiento de la información de todos
                                                    los fondos.
                                                </td>
                                            </tr>
                                            <tr>
                                                <td valign="top">
                                                    •</td>
                                                <td style="padding-left: 5px">
                                                    Guarda un <b>registro respaldatorio</b>, absolutamente pormenorizado, <b>de cada ValorCP</b>
                                                    calculado.
                                                </td>
                                            </tr>
                                            <tr>
                                                <td valign="top">
                                                    •</td>
                                                <td style="padding-left: 5px">
                                                    <b>Reduce la carga operativa</b>, y el riesgo de cometer errores de transcripción,
                                                    al disponer de opciones automáticas de
                                                    <table>
                                                        <tr>
                                            ...
                                            <tr>
                                                <td valign="top">
                                                    •</td>
                                                <td style="padding-left: 5px">
                                                    Mantiene toda la <b>información histórica</b>, sin descuidar la performance de acceso
                                                    a datos operativos.
                                                </td>
                                            </tr>
                                            <tr>
                                                <td valign="top">
                                                    •</td>
                                                <td style="padding-left: 5px">
                                                    Registra toda la actividad de los usuarios y de los administradores de seguridad
                                                    en <b>Logs de auditoria</b>.
                                                </td>
                                            </tr>
                                            <tr>
                                                <td valign="top">
                                                    •</td>
                                                <td style="padding-left: 5px">
                                                    <b>Workflow parametrizable</b>: que soporta todas las acciones sobre el proceso,
                                                    operaciones, precios, cierres de cambio, etc.; en el que se define la cantidad y
                                                    jerarquía de funcionarios intervinientes y si exige control por oposición.
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
