<%@ Page Language="C#" MasterPageFile="~/CedeiraAJAX.Master" AutoEventWireup="true" CodeBehind="SoloDispPUsuariosActivCP.aspx.cs" Inherits="CedeiraAJAX.SoloDispPUsuariosActivCP"  %>
                ...
                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; padding-top: 10px">
                    ...
                    <tr>
                        <td align="left" style="padding-top: 10px; padding-left: 32px; padding-right: 32px">
                            <asp:Label ID="Label1" runat="server" SkinID="MensajePaginaSinWidth" Text="Esta opción esta disponible sólo para usuarios habilitados por los ADMINISTRADORES.  Por favor, póngase en contacto con Cedeira Software Factory, para solucionar el inconveniente.  Muchas gracias."></asp:Label>
                        </td>
                    </tr>
                </table>
            </td>
