...
<asp:Content ID="XMLContent" runat="Server" ContentPlaceHolderID="ContentPlaceHolderNoAutenticado">
	<asp:ScriptManager ID="loteScriptManager" runat="server" ScriptMode="Auto">
	</asp:ScriptManager>
												...
												<td align="left" valign="top">
													...
													<table border="0" cellpadding="0" cellspacing="0" style="width: 780px">
														...
														<tr>
															...
															<td style="">
																<asp:UpdatePanel ID="ptoVentaUpdatePanel" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="false">
																	<ContentTemplate>
																		<table border="0" cellpadding="0" cellspacing="0" style="">
																			<tr>
														...
														<table border="0" cellpadding="0" cellspacing="0">
															...
															<tr>
																<td class="TextoLabelFEAVendedor" style="width: 390px">
																	...
																	<asp:Label ID="Tipo_de_cambioLabel" runat="server" Text="Tipo de cambio:" Visible="false">
																	</asp:Label></td>
																<td class="TextoLabelFEAVendedorDet">
