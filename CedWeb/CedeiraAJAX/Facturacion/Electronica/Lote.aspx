<%@ Page AutoEventWireup="true" Buffer="true" Codebehind="Lote.aspx.cs" Culture="en-GB" Inherits="CedeiraAJAX.Facturacion.Electronica.Lote"
    Language="C#" MaintainScrollPositionOnPostback="true" MasterPageFile="~/Facturacion/Electronica/FacturaElectronica.Master"
    Title="Factura Electrónica Gratis(Interfacturas - AFIP)" UICulture="en-GB" %>
                                                                    ...
                                                                    <tr>
                                                                        <td class="TextoLabelFEAVendedor" style="">
                                                                            ...
                                                                            <asp:RequiredFieldValidator ID="puntoVentaRequiredFieldValidator" runat="server"
                                                                                ControlToValidate="Punto_VentaTextBox" ErrorMessage="punto de venta" SetFocusOnError="True">* </asp:RequiredFieldValidator>Punto
                                                                            de venta:
                                                                        </td>
                                                                        <td class="TextoLabelFEAVendedorDet" style="">
                                                                            <asp:TextBox ID="Punto_VentaTextBox" runat="server" AutoPostBack="True" OnTextChanged="Punto_VentaTextBox_TextChanged"
                                                                                SkinID="TextoBoxFEAVendedorDet"></asp:TextBox>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0" style="width: 780px">
                                                        <tr>
                                                            ...
                                                            <td class="TextoLabelFEAVendedorChCh" style="text-align: left;">
                                                                <asp:CheckBox ID="Presta_ServCheckBox" runat="server" />
                                                            </td>
                                                            <td style="width: 5px;">
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td align="center" style="width: 100%">
                                                                ...
                                                                <asp:Label ID="CompradorExclusivoPremiumLabel" runat="server" Font-Size="X-Small"
                                                                    ForeColor="brown" Text="(exclusivo SERVICIO PREMIUM)" Visible="false"></asp:Label>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                        ...
                                                        <tr>
                                                            <td colspan="2" style="padding-top: 5px; text-align: right;">
                                                                <table border="0" cellpadding="0" cellspacing="0" style="text-align: right;">
                                                                    <tr>
                                                                        <td class="TextoLabelFEAVendedorCh" style="">
                                                                            Nro.:
                                                                        </td>
                                                                        <td class="TextoBoxFEAVendedorDetChCh" style="">
                                                                            <asp:TextBox ID="Domicilio_Numero_CompradorTextBox" runat="server" SkinID="TextoBoxFEAVendedorDetChCh"></asp:TextBox>
                                                                        </td>
                                                                        <td class="TextoLabelFEAVendedorChCh" style="">
                                                                            Piso:
                                                                        </td>
                                                                        <td class="TextoLabelFEADetVendedorChCh" style="">
                                                            ...
                                                            <td colspan="2" style="padding-top: 5px; text-align: right;">
                                                                <table border="0" cellpadding="0" cellspacing="0" style="text-align: right;">
                                                                    <tr>
                                                                        ...
                                                                        <td class="TextoLabelFEAVendedorDetChCh" style="">
                                            ...
                                            <tr>
                                                <td colspan="2" style="text-align: center; padding: 3px; font-weight: normal;">
                                                    <asp:ValidationSummary ID="ReferenciasEditValidationSummary" runat="server" BorderColor="Gray"
                                                        ...
                                                        ShowMessageBox="True" ValidationGroup="ReferenciasEditItem" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="2" style="text-align: center; padding: 3px; font-weight: normal;">
                                                    <asp:ValidationSummary ID="ReferenciasFooterValidationSummary" runat="server" BorderColor="Gray"
                                                        BorderWidth="1px" HeaderText="Hay que ingresar o corregir los siguientes campos:"
                                                        ShowMessageBox="True" ValidationGroup="ReferenciasFooter" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td rowspan="8" style="width: 1px; background-color: Gray;">
                                            ...
                                            <tr>
                                                <td colspan="2" style="text-align: center; padding: 3px; font-weight: normal;">
                                                    <asp:ValidationSummary ID="DescuentosGlobalesEditValidationSummary" runat="server"
                                                        ...
                                                        ShowMessageBox="True" ValidationGroup="DescuentosGlobalesEditItem" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="2" style="text-align: center; padding: 3px; font-weight: normal;">
                                                    <asp:ValidationSummary ID="DescuentosGlobalesFooterValidationSummary" runat="server"
                                                        BorderColor="Gray" BorderWidth="1px" HeaderText="Hay que ingresar o corregir los siguientes campos:"
                                                        ShowMessageBox="True" ValidationGroup="DescuentosGlobalesFooter" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td rowspan="8" style="width: 1px; background-color: Gray;">
                                            ...
                                            <tr>
                                                <td colspan="2" style="text-align: center; padding: 3px; font-weight: normal;">
                                                    <asp:ValidationSummary ID="ImpuestoEditItemValidationSummary" runat="server" BorderColor="Gray"
                                                        BorderWidth="1px" HeaderText="Hay que ingresar o corregir los siguientes campos:"
                                                        ShowMessageBox="True" ValidationGroup="ImpuestosGlobalesEditItem" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="2" style="text-align: center; padding: 3px; font-weight: normal;">
                                                    <asp:ValidationSummary ID="ImpuestoFooterValidationSummary" runat="server" BorderColor="Gray"
                                                        BorderWidth="1px" HeaderText="Hay que ingresar o corregir los siguientes campos:"
                                                        ShowMessageBox="True" ValidationGroup="ImpuestosGlobalesFooter" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td rowspan="8" style="width: 1px; background-color: Gray;">
