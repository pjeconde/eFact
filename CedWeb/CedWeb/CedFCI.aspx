                                ...
                                <tr>
                                    ...
                                    <td style="padding-top:15px">
                                        <table border="0" cellpadding="5px" cellspacing="0" style="border-style:solid; border-width:1px; border-color:#CD853F">
                                            <tr>
                                                <td valign="middle" align="center" style="width:80px; border-style:solid; border-width:1px; border-color:#CD853F">
                                                    Tablero<br />de<br />control
                                                </td>
                                                <td valign="top" style="border-style:solid; border-width:1px; border-color:#CD853F">
                                                    El Tablero de control es el front-end principal de la aplicación.&nbsp;&nbsp;&nbsp;En él se destacan tres paneles.&nbsp;&nbsp;&nbsp;El panel de <b>Proceso diario</b> sirve para guiar al usuario en el trabajo diario (permite saber rapidamente en qué estado está el proceso, cuál es el próximo paso que debe darse y cuáles son las tareas pendientes, en términos de cálculo de valores de cuotaparte).&nbsp;&nbsp;&nbsp;El panel de <b>Opciones</b> permite acceder a todas las funcionalidades del sistema (para ver más detalles, descargue la presentación).&nbsp;&nbsp;&nbsp;El panel de <b>Notificaciones</b> sirve para desplegar avisos del sistema (se hace visible sólo cuando es imprescindible).
                                                </td>
                                                <td style="border-style:solid; border-width:1px; border-color:#CD853F; width:200px">
                                                    <asp:Image ID="Image5" runat="server" ImageUrl="Imagenes/CedFCI-Tablero_ch.jpg" Width="200px" ImageAlign="Right" />
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td colspan="2" style="border-style:solid; border-width:1px; border-color:#CD853F">
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            <td valign="top">•</td>
                                                            <td style="padding-left:5px">
                                                                <b>Incorporación de novedades</b> (operaciones, cierres de cambio, precios, tasas de cuentas remuneradas, suscripciones y rescates de cuotapartes).
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td valign="top">•</td>
                                                            <td style="padding-left:5px">
                                                                <b>Revalúo de carteras</b> (devengado de intereses de colocaciones a plazo y sobre saldos de cuentas remuneradas, revalúo de titulos valores, ajustes por diferencia de cambio).
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td valign="top">•</td>
                                                            <td style="padding-left:5px">
                                                                Cálculo / liquidación de <b>honorarios administrativos</b> de las sociedades Gerente y Depositaria.
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td valign="top">•</td>
                                                            <td style="padding-left:5px">
                                                                Cálculo de los <b>valores de cuotaparte</b> de la(s) clase(s) emitida(s) para cada fondo.
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td valign="top">•</td>
                                                        ...
                                                        <tr>
                                                            <td valign="top">•</td>
                                                            <td style="padding-left:5px">
                                                                <b>Cierre diario</b> (que desencadena también el proceso de Apertura del siguiente día hábil y, cuando corresponde, los procesos de Cierre de Ejercicio y Depuración).
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td valign="top">•</td>
                                                            <td style="padding-left:5px">
                                                                En el proceso de <b>Apertura</b>, con el que arranca cada nuevo día, se liquidan los vencimientos pendientes, de pago o cobro, en forma automática (Ej.: rescates a pagar, compra de acciones a pagar, venta de acciones a cobrar).
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            ...
                                            <tr>
                                                <td valign="middle" align="center" style="border-style:solid; border-width:1px; border-color:#CD853F">
                                                    Incorporación<br />de<br />novedades
                                                </td>
                                                <td colspan="2" style="border-style:solid; border-width:1px; border-color:#CD853F">
                                                    <b>Operaciones</b><br />
                                            ...
                                            <tr>
                                                <td valign="middle" align="center" style="border-style:solid; border-width:1px; border-color:#CD853F">
                                                    Configuración<br />de<br />datos básicos
                                                </td>
                                                <td colspan="2" style="border-style:solid; border-width:1px; border-color:#CD853F">
                                                    <b>FCIs</b><br />
