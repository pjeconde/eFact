<%@ Page Language="C#" MasterPageFile="~/CedWeb.master" AutoEventWireup="true" CodeFile="~/CompradorCrear.aspx.cs" Inherits="CedWeb.CompradorCrear" MaintainScrollPositionOnPostback="true" %>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    ...
                                    <td style="height: 20px;">
                                        <asp:Label ID="TituloLabel" runat="server" Text="Alta de datos de Comprador" SkinID="TituloPagina"></asp:Label>
                                    </td>
                                </tr>
                            </table>                        
                            <!-- @@@@@@@@@@@@@@@@@@@@@@@@@@@-->
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td align="left" style="height: 24px">
                                                    <asp:Button ID="AceptarButton" runat="server" Text="Agregar" Width="100px" OnClick="AceptarButton_Click" TabIndex="22">
                                                    </asp:Button>
                                                </td>
