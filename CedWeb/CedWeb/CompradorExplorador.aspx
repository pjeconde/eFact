                            ...
                            <table cellpadding="0" cellspacing="0" border="0">
                                ...
                                <tr>
                                    <td style="padding-top:5px">
                                        <asp:Button ID="CrearButton" runat="server" Text="Nuevo" Width="100%" OnClick="CrearButton_Click"> </asp:Button>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding-top:5px">
                                        <asp:Button ID="EliminarButton" runat="server" Text="Eliminar" Width="100%" OnClick="EliminarButton_Click" Enabled="false"> </asp:Button>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding-top:5px">
                                        <asp:Button ID="ModificarButton" runat="server" Text="Modificar" Width="100%" OnClick="ModificarButton_Click" Enabled="false"> </asp:Button>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding-top:5px">
                                        <asp:Button ID="ConsultarButton" runat="server" Text="Consultar" Width="100%" OnClick="ConsultarButton_Click" Enabled="false"> </asp:Button>
                                    </td>
                                </tr>
                                <tr>
