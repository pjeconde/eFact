...
<body>
    ...
    <table cellpadding="0" cellspacing="0" border="0px" style="height: 142px; background-color: red;">
    <tr>
    <td>
        <table cellpadding="0" cellspacing="0" border="0px" style="height: 142px; background-color: Olive;">
            <tr>
                ...
                <td style="background-image: url('Imagenes/Ingreso/Box/BoxT.gif'); width:258px; height:38px;">
                    ...
                    <asp:Label ID="Label5" runat="server" Font-Bold="True" SkinID="TituloPaginaClaro" Text="Soluciones de negocio"></asp:Label></td>
