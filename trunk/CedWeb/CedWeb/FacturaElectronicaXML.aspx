<%@ Page AutoEventWireup="true" Buffer="true" CodeFile="FacturaElectronicaXML.aspx.cs"
    Culture="en-GB" Inherits="FacturaElectronicaXML" Language="C#" MaintainScrollPositionOnPostback="true"
    MasterPageFile="~/CedWeb.master" Title="Factura Electrónica Gratis(XML para Interfacturas)"
    UICulture="en-GB" %>
                                                            ...
                                                            <td colspan="2" style="text-align: center; padding: 3px; font-weight: normal;">
                                                                <asp:Panel runat="server" ID="detallePanel" ScrollBars="Auto" Width="760px" Height="200px" Wrap="true" BorderStyle="Ridge">
                                                                    <asp:GridView ID="detalleGridView" runat="server" AutoGenerateColumns="False" GridLines="Both"
                                                                        ...
                                                                        OnRowCommand="detalleGridView_RowCommand" OnRowEditing="detalleGridView_RowEditing" OnRowUpdated="detalleGridView_RowUpdated"
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <asp:TemplateField HeaderStyle-Font-Bold="false" HeaderStyle-Width="200px" HeaderText="Descripción del artículo">
                                                                                ...
                                                                                <EditItemTemplate>
                                                                                    <asp:TextBox ID="txtdescripcion" runat="server" Text='<%# Eval("descripcion") %>'></asp:TextBox><asp:RequiredFieldValidator ID="txtdescripcionEditRequiredFieldValidator"
                                                                                ...
                                                                                <FooterTemplate>
                                                                                    <asp:TextBox ID="txtdescripcion" runat="server" Text=''></asp:TextBox><asp:RequiredFieldValidator ID="txtdescripcionFooterRequiredFieldValidator" runat="server"
                                                                            ...
                                                                            <asp:TemplateField HeaderStyle-Font-Bold="false" HeaderStyle-Width="100px" HeaderText="Cantidad">
                                                                                ...
                                                                                <EditItemTemplate>
                                                                                    <asp:TextBox ID="txtcantidad" runat="server" Text='<%# Eval("cantidad") %>' Width="70px"></asp:TextBox><asp:RegularExpressionValidator ID="txtcantidadEditRegularExpressionValidator" runat="server"
                                                                            ...
                                                                            <asp:TemplateField HeaderStyle-Font-Bold="false" HeaderText="Importe">
                                                                                ...
                                                                                <FooterTemplate>
                                                                                    <asp:TextBox ID="txtimporte_total_articulo" runat="server" Text='' Width="70px"></asp:TextBox><asp:RegularExpressionValidator ID="txtimporte_total_articuloFooterRegularExpressionValidator"
                                                                                        ...
                                                                                        >*</asp:RegularExpressionValidator><asp:RequiredFieldValidator ID="txtimporte_total_articuloFooterRequiredFieldValidator"
                                                                            ...
                                                                            <asp:TemplateField HeaderStyle-Font-Bold="false" HeaderText="Importe IVA">
                                                                                ...
                                                                                <FooterTemplate>
                                                                                    <asp:TextBox ID="txtimporte_alicuota_articulo" runat="server" Text='' Width="70px"></asp:TextBox><asp:RegularExpressionValidator ID="txtimporte_alicuota_articuloFooterRegularExpressionValidator"
