<%@ Page Language="C#" MasterPageFile="~/CedWeb.master" AutoEventWireup="true" CodeFile="~/AdministracionVendedorExplorador.aspx.cs" Inherits="CedWeb.AdministracionVendedorExplorador" MaintainScrollPositionOnPostback="true"%>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    ...
                                    <td style="height:20px;">
                                        <asp:Label ID="TituloLabel" runat="server" Text="Vendedores" SkinID="TituloPagina"></asp:Label>
                                    </td>
                                </tr>
                            </table>  
                        </td>
