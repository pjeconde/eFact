<%@ Page Language="C#"  MasterPageFile="~/Admin/Administracion.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="CedeiraAJAX.Admin.Default" %>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td align="left" style="padding-top: 10px" valign="middle">
                                        ...
                                        ,&nbsp;
                                        <asp:HyperLink ID="HyperLink6" runat="server" NavigateUrl="~/Admin/Vendedor/Explorador.aspx"
                                        ...
                                        ,&nbsp;
                                        <asp:HyperLink ID="HyperLink7" runat="server" NavigateUrl="~/Admin/Comprador/Explorador.aspx"
                                        ...
                                        ,&nbsp;
                                        <asp:HyperLink ID="HyperLink3" runat="server" NavigateUrl="~/Admin/Publicacion/Explorador.aspx"
                                        ...
                                        ,
                                        <asp:HyperLink ID="CertificadosHyperLink" runat="server" NavigateUrl="~/Admin/Certificados/Explorador.aspx"
