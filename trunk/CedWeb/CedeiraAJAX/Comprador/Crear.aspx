<%@ Page Language="C#" MasterPageFile="~/CedeiraAJAX.Master" AutoEventWireup="true" CodeBehind="Crear.aspx.cs" Inherits="CedeiraAJAX.Comprador.Crear" %>
...
<asp:Content ID="Content2" runat="Server" ContentPlaceHolderID="ContentPlaceHolderNoAutenticado">
	<asp:ScriptManager ID="CrearCompradorScriptManager" runat="server">
	</asp:ScriptManager>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td style="height:20px;">
                                        <asp:Label ID="TituloLabel" runat="server" SkinID="TituloPagina" Text="Alta de datos de Comprador"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                            <!-- @@@@@@@@@@@@@@@@@@@@@@@@@@@-->
