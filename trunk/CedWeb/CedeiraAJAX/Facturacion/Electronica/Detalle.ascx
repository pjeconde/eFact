					...
					<asp:GridView ID="detalleGridView" runat="server" AutoGenerateColumns="False" BorderColor="Gray"
						...
						<Columns>
							...
							<asp:TemplateField HeaderStyle-Font-Bold="false" HeaderText="Importe">
								...
								<EditItemTemplate>
									<asp:TextBox ID="txtimporte_total_articulo" runat="server" AutoPostBack="true" OnTextChanged="CalcularImporteArtEnEdicion" 
									    Text='<%# Eval("importe_total_articulo") %>'
								...
								<FooterTemplate>
									<asp:TextBox ID="txtimporte_total_articulo" runat="server" AutoPostBack="true" OnTextChanged="CalcularImporteArtEnFooter"
									    Text='' Width="70px"></asp:TextBox>
