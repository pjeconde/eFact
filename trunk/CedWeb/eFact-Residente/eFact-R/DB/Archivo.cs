...
namespace eFact_R.DB
{
    class Archivo: db
    {
        ...
        public void Consultar(List<Entidades.Archivo> Archivos, RN.Tablero.TipoConsultaArchivos TipoConsultaArchivos, RN.Archivo.OtrosFiltros OtrosFiltros, DateTime FechaDsd, DateTime FechaHst)
        {
            StringBuilder commandText = new StringBuilder();
            //Query Lotes
            commandText.Append("select * from Archivos ");
            if (TipoConsultaArchivos == RN.Tablero.TipoConsultaArchivos.FechaCreacion)
            {
            ...
            if (OtrosFiltros != eFact_R.RN.Archivo.OtrosFiltros.SinAplicar)
            {
                if (OtrosFiltros == eFact_R.RN.Archivo.OtrosFiltros.OK)
                {
        ...
        public void Leer(eFact_R.Entidades.Archivo Archivo)
        {
            StringBuilder commandText = new StringBuilder();
            //Query Lotes
            commandText.Append("select * from Archivos ");
        ...
        private void Copiar(DataRow Desde, eFact_R.Entidades.Archivo Hasta)
        {
        ...
        public string Insertar(eFact_R.Entidades.Archivo Archivo, bool Handler)
        {
            StringBuilder commandText = new StringBuilder();
